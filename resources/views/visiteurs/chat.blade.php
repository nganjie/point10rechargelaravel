      ...
      <div class="flex flex-col flex-auto h-full p-6">
        ...
        >
          <div class="flex flex-col h-full overflow-x-auto mb-4">
            <div class="flex flex-col h-100 w-70 overflow-y-auto">
              <div class="grid grid-cols-12 gap-y-2 ">
                <div id="chat" class="col-start-1 col-end-13 ">
          ...
          >
            ...
            <div class="flex-grow ml-4">
              <div class="relative w-full">
                ...
                name="name"
                  type="text"
                  class="flex w-30 border rounded-xl focus:outline-none focus:border-indigo-300 pl-4 h-10"
                />
                <button
